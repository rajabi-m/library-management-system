...
public class LibraryTests {
    ...
    public void testUpdateBookStatus(){
        ...
        library.updateBookStatus("The Lord of the Rings", "J.R.R. Tolkien", 1954, BookStatus.Borrowed);
    ...
    public void testLibraryOperations() {
        ...
        assertEquals("The book status was successfully updated!", library.updateBookStatus("The Lord of the Rings", "J.R.R. Tolkien", 1954, BookStatus.Borrowed));
        assertEquals(BookStatus.Borrowed, library.getBooksByTitle("The Lord of the Rings").getHead().getStatus());
        ...
        library.sortBooksByReleaseYear();
        var sortedBooks = library.getBooks();
